...
describe('insufficient balance', () =>{
	it('Pay with valid card data and insufficient balance', () => {
		...
		cy.paymentProcess(card_data.AmEx, 9)
			...
			cy.log('Check Visa insufficient balance input')
		cy.paymentProcess(card_data.Visa, 9)

			cy.log('Check Discover insufficient balance input')
		cy.paymentProcess(card_data.Discover, 9)
	})
